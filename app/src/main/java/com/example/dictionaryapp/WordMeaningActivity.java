...
import com.example.dictionaryapp.Fragments.FragmentAntonyms;
import com.example.dictionaryapp.Fragments.FragmentDefinition;
import com.example.dictionaryapp.Fragments.FragmentExamples;
import com.example.dictionaryapp.Fragments.FragmentSynonyms;
...
public class WordMeaningActivity extends AppCompatActivity {
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        private ViewPagerAdapter(@NonNull FragmentManager manager) {
            super(manager);
        }
    ...
    private void setupViewPager(ViewPager viewPager){
        ...
        adapter.addFrag(new FragmentExamples(), "Examples");
