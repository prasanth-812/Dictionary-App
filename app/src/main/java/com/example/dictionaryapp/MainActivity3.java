...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (myDbHelper.checkDataBase()) {
            ...
            LoadDatabaseAsync task = new LoadDatabaseAsync(MainActivity3.this);
            task.execute();
        }
        ...
        suggestionAdapter = new SimpleCursorAdapter(MainActivity3.this, R.layout.suggestion_row, null, from, to, 0) {
            @Override
        ...
        search.setOnSuggestionListener(new SearchView.OnSuggestionListener() {
            ...
            public boolean onSuggestionClick(int position) {
                ...
                Intent intent = new Intent(MainActivity3.this, WordMeaningActivity.class);
    ...
    private void showAlertDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity3.this, R.style.MyDialogTheme);
